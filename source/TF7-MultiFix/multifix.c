...
void TFFixesInject()
{
    ...
    minj_SetMemsetAddress(0xB9AB0);
    minj_SetMemcpyAddress(0xB9718);
#endif
    ...
    minj_MakeCALL(0x5BA4, (uintptr_t)&FirstLoopFunc_Hook);
    // EhPad_Get with input blocking
    minj_MakeJMPwNOP(0x3E7D4, (uintptr_t)&EhPad_Get);
    ...
    uintptr_t modreadcb = minj_WriteLUI_ADDIU(0x41BF0, (uintptr_t)&lEhScript_ModuleRead_FinishCB_Hook, MIPSR_a2);
    ptr_lEhScript_ModuleRead_FinishCB = (int(*)(uintptr_t, uintptr_t))modreadcb;


    uintptr_t modloadcb = minj_WriteLUI_ADDIU(0x3E2B0, (uintptr_t)&lEhModule_Load_EndCallback_Hook, MIPSR_a2);
    ...
    minj_MakeJMPwNOP(0x2080, 0x21C4 + base_addr);
    minj_MakeJMPwNOP(0x20BC, 0x20E4 + base_addr);

    // fix line spacing
    minj_MakeNOP(0x17D0);
    minj_WriteMemory32(0x17C0, 0x00A02021); // move a0, a1
    minj_WriteMemory16(0x1448, LINE_SPACING_VAL);

    minj_WriteMemory16(0x2860, LINE_SPACING_VAL);
    minj_WriteMemory16(0x2910, LINE_SPACING_VAL);
    minj_WriteMemory16(0x2944, LINE_SPACING_VAL);


    minj_WriteMemory16(0x19D4, (uint16_t)(-LINE_SPACING_VAL));
    minj_WriteMemory16(0x1F88, (uint16_t)(-LINE_SPACING_VAL));
    minj_WriteMemory16(0x3888, (uint16_t)(-LINE_SPACING_VAL));
    minj_WriteMemory16(0x393C, (uint16_t)(-LINE_SPACING_VAL));

    minj_WriteMemory16(0x549C, (uint16_t)(-LINE_SPACING_VAL));

    minj_WriteMemory32(0x5B10, 0x34050001); // li a1, 1
    minj_MakeCALL(0xF2BC, (uintptr_t)&YgSys_GetLang_Hook);
    minj_MakeCALL(0x17774, (uintptr_t)&YgSys_GetLang_Hook);
    minj_MakeCALL(0x1820C, (uintptr_t)&YgSys_GetLang_Hook);
    minj_MakeCALL(0x182B0, (uintptr_t)&YgSys_GetLang_Hook);
    minj_MakeCALL(0x19490, (uintptr_t)&YgSys_GetLang_Hook);
    minj_MakeCALL(0x1943C, (uintptr_t)&YgSys_GetLang_Hook);
    minj_MakeCALL(0xCB54, (uintptr_t)&YgSys_GetLang_Hook);
    minj_WriteMemory16(0x194AC, 0x480);

    minj_MakeCALL(0x14F0, (uintptr_t)&YgSys_GetLang_Hook);


#ifndef __INTELLISENSE__
    // global font Y offset
    minj_MakeCALL(0x185C, (uintptr_t)&hkPrintLineFontYOffset);
    minj_MakeCALL(0x35A8, (uintptr_t)&hkPrintBoxFontYOffset);
#endif

    minj_MakeJMPwNOP(0x9108, (uintptr_t)&YgSys_GetAssignButton_Hook);
    // matrix font stuff
    minj_MakeJMPwNOP(0x2230, (uintptr_t)&YgFont_SetMatrixFontFlg_Hook);
    minj_MakeNOP(0xF2AC);
    minj_MakeNOP(0x19B44);

    // banlist stuff
    minj_MakeJMPwNOP(0x2AA80, (uintptr_t)&YgSys_GetLimitation_Hook);
    minj_MakeJMPwNOP(0x8A4C, (uintptr_t)&YgSys_GetLimitation_Default_Hook);

    // card unlock
    minj_MakeJMPwNOP(0x2CF14, (uintptr_t)&YgSys_GetTrunk_Hook);
    minj_MakeJMPwNOP(0x2D298, (uintptr_t)&YgSys_GetMark_Hook);


    // infinite DP
    minj_MakeJMPwNOP(0x27B2C, (uintptr_t)&YgSys_GetDuelPoint_Hook);
    // inline hook to reduce size
    minj_MakeJMP(0x27B70, (uintptr_t)&YgSys_UpdateDuelPoint_Hook);
    YgSys_UpdateDuelPoint_Hook_ExitNoInf = 0x27B78 + base_addr;
    YgSys_UpdateDuelPoint_Hook_ExitInf = 0x27BD8 + base_addr;

    // unlock boxes
    minj_MakeJMPwNOP(0x2B594, (uintptr_t)&YgSys_GetBoxStatus_Hook);

    minj_MakeJMP(0x2B53C, (uintptr_t)&YgSys_SetBoxStatus_Hook);
    YgSys_SetBoxStatus_Hook_ExitNoUnl = 0x2B544 + base_addr;
    YgSys_SetBoxStatus_Hook_ExitUnl = 0x2B584 + base_addr;



#ifdef YG_GETLANG_DEBUG
    minj_MakeJMPwNOP(0x2B178, (uintptr_t)&YgSys_GetLang);
#endif

    // YgSys_CardDetail_Raw_DrawSmallText fix
    minj_MakeCALL(0xD7D8, (uintptr_t)&YgFont_GetShadowFlg_Hook);
    minj_MakeCALL(0xD7E4, (uintptr_t)&YgFont_SetShadowFlg_Hook1);
    minj_MakeCALL(0xD80C, (uintptr_t)&YgFont_SetShadowFlg_Hook2);
}