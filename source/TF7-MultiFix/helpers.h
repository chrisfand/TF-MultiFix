...
#define YGFONT_FLAGS_ADDR 0x20149C
...
#define MAIN_EHHEAP_ADDR 0x336D0C
#define EHPAD_ADDR 0x65707C
#define DUELPOINT_OFFSET 0x2D5A0
#define DUELPOINT_OFFSET2 0x2D5A4
#define DUELPOINT_MAX 999999999
#define YG_CHARACTER_COUNT 180 //tf6
#define YG_CHARACTER_MAXTRUST 4000 //tf6
#define YG_CHARACTER_SKIP_TOP 2 //tf6
#define YG_CHARACTER_SKIP_BOTTOM 57 //tf6

#define PERSONALINFO_LVL_ADDR 0x2D598
#define PERSONALINFO_EXP_ADDR 0x2D59C
...
#define YG_CARD_ID_END 11658 //must increase later when re-activating cards hidden in TF7's duel engine

// These are the cue indexes in BGM.acb
#define SOUND_ID_MENU_CURSOR 0x20
#define SOUND_ID_MENU_DECIDE 0x21
#define SOUND_ID_MENU_CANCEL 0x1F
#define SOUND_ID_MENU_INVALID 0x1E
#define SOUND_ID_MENU_WINDOWPOPUP_1 0x26
#define SOUND_ID_MENU_WINDOWPOPUP_2 0x26 // unused currently
...
#define DEFAULT_LIMITLIST_ADDR 0xD2720
#define DEFAULT_LIMITLIST_COUNT 304

#define RECIPE_COUNT 497 //tf6
