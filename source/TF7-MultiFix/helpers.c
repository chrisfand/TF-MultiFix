...
{
    _YgSys_InitApplication = (void (*)())(0x86C8 + base_addr);
    _FirstLoopFunc = (void (*)(int))(0x2C878 + base_addr);
    //_EhPad_Get = (uintptr_t(*)())(0x3A428 + base_addr); //tf6
    _YgFont_PrintLine64 = (uintptr_t(*)(int, int, uintptr_t, wchar_t*))(0x1808 + base_addr);
    _YgFont_PrintLineFit64 = (uintptr_t(*)(int, int, uintptr_t, wchar_t*, int32_t))(0x44E0 + base_addr);
    
    
    _YgFont_SetShadowFlg = (void (*)(int))(0x2158 + base_addr);
    _YgFont_SetRubyCharFlg = (void (*)(int))(0x229C + base_addr);
    _YgFont_GetShadowFlg = (int (*)())(0x2194 + base_addr);
    
    _YgFont_GetStrWidth = (int (*)(wchar_t*))(0x1378 + base_addr);
    _YgSys_wcscat = (wchar_t* (*)(wchar_t*, const wchar_t*))(0x0002D80C + base_addr);
    _YgSys_wcscpy = (wchar_t* (*)(wchar_t*, const wchar_t*))(0x0002D77C + base_addr);
    _YgSys_wcsncpy = (wchar_t* (*)(wchar_t*, const wchar_t*, size_t))(0x2D7BC + base_addr);
    _YgSys_wcsfind = (int (*)(const wchar_t*, wchar_t))(0x2D740 + base_addr);
    
    _YgSys_wcslen = (size_t(*)(const wchar_t*))(0x0002D71C + base_addr);
    _YgSys_memset = (void* (*)(void*, int, size_t))(0xB9AB0 + base_addr);
    _YgSys_memcpy = (void* (*)(void*, const void*, size_t))(0xB9718 + base_addr);
    _YgSys_GetOption = (uintptr_t(*)())(0x2AB34 + base_addr);
    _YgSys_GetUserName = (wchar_t*(*)())(0x2792C + base_addr);
    _YgSys_uGetPartnerName = (wchar_t* (*)(int, int, int))(0x24C84 + base_addr);
    _YgSys_GetStrFromResource = (wchar_t* (*)(uintptr_t, int))(0x95A0 + base_addr);
    _EhFolder_SearchFile = (uintptr_t(*)(uintptr_t, const char*, uintptr_t))(0x384BC + base_addr);
    _YgSys_strcmp = (int (*)(const char*, const char*))(0xB9C94 + base_addr);
    _YgSys_strcpy = (char* (*)(char*, const char*))(0xB9CC8 + base_addr);
    _YgSys_strncpy = (char* (*)(char*, const char*, size_t))(0xB9DF4 + base_addr);
    _YgSys_strcat = (char* (*)(char*, const char*))(0xB9C38 + base_addr);
    _YgSys_strlen = (size_t(*)(const char*))(0xB9D0C + base_addr);
    _sceCccUTF8toUTF16 = (int (*)(wchar_t*, size_t, char*))(0xC9908 + base_addr);
    _YgSys_sprintf = (int (*)(char*, const char*, ...))(0xB8294 + base_addr);
    _YgSys_SndPlaySE = (int (*)(int))(0x30394 + base_addr);
    _YgSys_GetTrunkFromMRK = (uintptr_t(*)(int))(0x2CE8C + base_addr);
    _YgSys_GetPersonalInfoPtr = (uintptr_t(*)())(0x8918 + base_addr);
    _YgSys_GetBoxPtr = (uintptr_t(*)(int))(0x2B45C + base_addr);
    _YgSys_GetTrust = (int(*)(int))(0x2BBC0 + base_addr);
    _YgSys_SetTrust = (int(*)(int, int))(0x2BBF8 + base_addr);
    _YgSys_GetChrNameFromID = (wchar_t*(*)(int, int))(0x24D14 + base_addr);
    _YgFont_GetWordSeparateFlg = (int (*)())(0x2200 + base_addr);
    _YgFont_SetWordSeparateFlg = (void (*)(int))(0x21C4 + base_addr);

    _YgSys_AddNpcRecipe = (int(*)(int, int))(0x2BA80 + base_addr);
    _YgSys_ReciveRecipeFromNpc = (int(*)(int, int))(0x2C034 + base_addr);
    //_YgSys_Recipe_Id2Deck = (void(*)(int, void*))(0x23CF8 + base_addr); //tf6
    _uYgSys_Recipe_ChrId2DeckId = (int(*)(int, int))(0x25C80 + base_addr);

    _YgSys_Ms_GetDirPath = (void (*)(char*))(0x12408 + base_addr);
    //_YgSys_Ms_GetDirName = (void (*)(char*))(0x11528 + base_addr); //tf6

    _YgSys_uGetExp = (int (*)(int))(0x27A80 + base_addr);

    // optional functions
    //_YgSys_GetUnlockNpcInfo = (uintptr_t(*)(int))(0x2A268 + base_addr); //tf6
    //_YgSys_wcscmp = (wchar_t* (*)(const wchar_t*, const wchar_t*))(0x2BE74 + base_addr); //tf6
    //_YgFont_GetRubyCharFlg = (int (*)())(0x22C4 + base_addr); //tf6
    //_YgAdh_Update = (void (*)())(0x1D75C + base_addr); //tf6

    // window draw stuff
    _EhPckt_Open = (uintptr_t(*)(int, int))(0x0003EF54 + base_addr);
    _EhPckt_Close = (int(*)(uintptr_t))(0x3F040 + base_addr);
    _YgFont_SetEhPckt = (uintptr_t(*)(uintptr_t))(0x233C + base_addr);
    _YgFont_GetEhPckt = (uintptr_t(*)())(0x2380 + base_addr);
    _YgFont_SetSize = (void(*)(int, int))(0x12B8 + base_addr);
    _YgFont_SetChColorFlg = (void(*)(int))(0x20EC + base_addr);
    _YgFont_SetDefaultColor = (void(*)(uint32_t))(0x130C + base_addr);
